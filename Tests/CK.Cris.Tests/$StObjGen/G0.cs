[assembly: CK.StObj.Signature( @"f180cb9fd811a422b0f44c3a05e5d6cd7967713c" )]
...
_stObjs[1] = _finalStObjs[1] = new GFinalStObj( new CK.Cris.Tests.ICommandWithPocoResult_CKFactory_CK(), typeof(CK.Cris.Tests.ICommandWithPocoResult_CKFactory_CK), 
Type.EmptyTypes, 
new[]{typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithPocoResult>), typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithMorePocoResult>), typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithAnotherPocoResult>), typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandUnifiedWithTheResult>)}, 
typeof(CK.Cris.Tests.ICommandWithPocoResult_CKFactory_CK), null, this, 1 );
_map = new Dictionary<Type,GFinalStObj>();
_map.Add( typeof(CK.Core.PocoDirectory), (GFinalStObj)_stObjs[0] );
_map.Add( typeof(CK.Cris.Tests.ICommandWithPocoResult_CKFactory_CK), (GFinalStObj)_stObjs[1] );
_map.Add( typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithPocoResult>), (GFinalStObj)_stObjs[1] );
_map.Add( typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithMorePocoResult>), (GFinalStObj)_stObjs[1] );
_map.Add( typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithAnotherPocoResult>), (GFinalStObj)_stObjs[1] );
_map.Add( typeof(CK.Core.IPocoFactory<CK.Cris.Tests.ICommandUnifiedWithTheResult>), (GFinalStObj)_stObjs[1] );
int iStObj = 2;
while( --iStObj >= 0 ) {
...
_simpleServiceList = new IStObjServiceClassDescriptor[3];
_simpleServiceList[0] = new StObjServiceClassDescriptor(typeof(CK.Cris.CommandDirectory), typeof(CK.Cris.CommandDirectory_CK), ((CK.Core.AutoServiceKind)8L), Type.EmptyTypes, Type.EmptyTypes, Type.EmptyTypes);
_simpleServiceList[1] = new StObjServiceClassDescriptor(typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerUnified), typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerUnified), ((CK.Core.AutoServiceKind)8L), Type.EmptyTypes, Type.EmptyTypes, new[]{typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerOfBase), typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerWithMore), typeof(CK.Cris.ICommandHandler<CK.Cris.Tests.ICommandWithPocoResult>)});
_simpleServiceList[2] = new StObjServiceClassDescriptor(typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerWithAnother), typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerWithAnother), ((CK.Core.AutoServiceKind)8L), Type.EmptyTypes, Type.EmptyTypes, Type.EmptyTypes);
_simpleServiceMappings = new Dictionary<Type, IStObjServiceClassDescriptor>(6);
_simpleServiceMappings.Add( typeof(CK.Cris.CommandDirectory), _simpleServiceList[0] );
_simpleServiceMappings.Add( typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerOfBase), _simpleServiceList[1] );
_simpleServiceMappings.Add( typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerWithAnother), _simpleServiceList[2] );
_simpleServiceMappings.Add( typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerWithMore), _simpleServiceList[1] );
_simpleServiceMappings.Add( typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerUnified), _simpleServiceList[1] );
_simpleServiceMappings.Add( typeof(CK.Cris.ICommandHandler<CK.Cris.Tests.ICommandWithPocoResult>), _simpleServiceList[1] );
_manualServiceList = new IStObjServiceClassFactory[0];
_manualServiceMappings = new Dictionary<Type, IStObjServiceClassFactory>( 0 );
_vFeatures = new VFeature[]{ new VFeature( @"CK.Cris",CSemVer.SVersion.Parse( @"0.0.0-0" ) ), new VFeature( @"CK.Cris.Tests",CSemVer.SVersion.Parse( @"0.0.0-0" ) ), new VFeature( @"CK.StObj.Model",CSemVer.SVersion.Parse( @"0.0.0--02wak5d-local+v14.0.1" ) )};
...
namespace Tests
{
public sealed class ICommandWithPocoResult_CKFactory_CK : CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithPocoResult>, CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithMorePocoResult>, CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithAnotherPocoResult>, CK.Core.IPocoFactory<CK.Cris.Tests.ICommandUnifiedWithTheResult>, CK.Cris.ICommandModel
{
PocoDirectory IPocoFactory.PocoDirectory => PocoDirectory_CK.Instance;
public Type PocoClassType => typeof(ICommandWithPocoResult_CK);
public IPoco Create() => new ICommandWithPocoResult_CK();
public string Name => @"CK.Cris.Tests.ICommandWithPocoResult";
public IReadOnlyList<string> PreviousNames => Array.Empty<string>();
CK.Cris.Tests.ICommandWithPocoResult CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithPocoResult>.Create() => new CK.Cris.Tests.ICommandWithPocoResult_CK();
CK.Cris.Tests.ICommandWithMorePocoResult CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithMorePocoResult>.Create() => new CK.Cris.Tests.ICommandWithPocoResult_CK();
CK.Cris.Tests.ICommandWithAnotherPocoResult CK.Core.IPocoFactory<CK.Cris.Tests.ICommandWithAnotherPocoResult>.Create() => new CK.Cris.Tests.ICommandWithPocoResult_CK();
CK.Cris.Tests.ICommandUnifiedWithTheResult CK.Core.IPocoFactory<CK.Cris.Tests.ICommandUnifiedWithTheResult>.Create() => new CK.Cris.Tests.ICommandWithPocoResult_CK();
public Type CommandType => PocoClassType;
public int CommandIdx => 0;
public string CommandName => Name;
public Type ResultType => typeof(CK.Cris.Tests.IUnifiedResult);
public MethodInfo Handler => (System.Reflection.MethodInfo)typeof(CK.Cris.Tests.ICommandHandlerTests.CmdHandlerUnified).GetMembers( System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.DeclaredOnly )[0];
CK.Cris.ICommand CK.Cris.ICommandModel.Create() => (CK.Cris.ICommand)Create();
public ICommandWithPocoResult_CKFactory_CK()
{
PocoDirectory_CK.Register( this );
ICommandWithPocoResult_CK._factory = this;
}
}
public sealed class ICommandWithPocoResult_CK : IPocoClass, CK.Cris.Tests.ICommandWithPocoResult, CK.Cris.Tests.ICommandWithMorePocoResult, CK.Cris.Tests.ICommandWithAnotherPocoResult, CK.Cris.Tests.ICommandUnifiedWithTheResult
{
internal static ICommandWithPocoResult_CKFactory_CK _factory;
public IPocoFactory Factory => _factory;
public CK.Cris.ICommandModel CommandModel => _factory;
public ICommandWithPocoResult_CK()
{
}
}
...
{
CK.Cris.Tests.ICommandWithPocoResult_CK._factory,
};
return list;
}
}
