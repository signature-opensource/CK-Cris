...
namespace CK.Cris
{
    ...
    /// <list type="bullet">
    ///     <item>The <see cref="Execute{T}(IActivityMonitor, T, IAuthenticationInfo?, bool, ActivityMonitor.Token?)"/> method to submit a command.</item>
    ...
    public class CrisBackgroundExecutor : AbstractCommandExecutor, ISingletonAutoService
    {
        ...
        public IExecutingCommand<T> Execute<T>( IActivityMonitor monitor,
                                                T command,
