...
{
    /// <summary>
    /// Executes commands on services provided to <see cref="ExecuteCommandAsync(IActivityMonitor, IServiceProvider, IAbstractCommand)"/>.
    ...
    public abstract class RawCommandExecutor : ISingletonAutoService
    {
        ...
        public abstract Task<object?> RawExecuteCommandAsync( IServiceProvider services, IAbstractCommand command );
    }
}
