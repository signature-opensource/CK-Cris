...
namespace CK.Cris.UbiquitousValues
{
    ...
    /// <para>
    /// Commands (quite always <see cref="ICommandPart"/>) can define these properties thanks to the <see cref="UbiquitousValueAttribute"/>.
    /// </para>
    /// <para>
    /// These properties cannot be null: they necessarily exist and a [PostHandler] method with the
    /// <see cref="IUbiquitousValuesCollectCommand"/> must set them.
    /// </para>
    /// </summary>
